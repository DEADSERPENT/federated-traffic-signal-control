...
\caption{Byzantine robustness under sensor-noise attacks (3-seed average): (a) absolute MAE vs.\ number of compromised intersections out of 9; (b) relative MAE degradation normalised to the clean baseline. Multi-Krum maintains near-clean accuracy ($\leq$2.7\% degradation) while standard FedAvg collapses by 79\% with just 2 Byzantine clients.}
\label{fig:byzantine}
\end{figure}
